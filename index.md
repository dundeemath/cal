...
- Some applications must be submitted for **internal** review before the funder's posted deadline (e.g., for internal costing or because the School/University must select only one application to submit). 
